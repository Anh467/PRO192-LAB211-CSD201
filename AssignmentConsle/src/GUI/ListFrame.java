...
public class ListFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("                 ENTER 2 NUMBER");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        double d1, d2;
        if((jTextField1.getText().equalsIgnoreCase("")==true)||(jTextField2.getText().equalsIgnoreCase("")==true)){
            jLabel1.setText("!!!ALL TEXT FIELD MUST BE FILL!!!");
        }
        try {
            d1= Double.parseDouble(jTextField1.getText());
            d2= Double.parseDouble(jTextField2.getText());
            MainJFrameProgram.setList(d1, d2);
            dispose();
        } catch (Exception e) {
            jLabel1.setText("!!!NUMBER WRONG FORMAT!!!");
        }
