...
//In ra màn hình kết quả
        if(cirA.checkCir(cirB)== true)
             System.out.println("Two circle Circle(A"+cirA+") and Circle(B"+cirB+") are in outer contact");
        else System.out.println("Two circle Circle(A"+cirA+") and Circle(B"+cirB+") are not in outer contact");
    }
